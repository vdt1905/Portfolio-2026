...
export const STOPS = [
  {
    id: "earth", year: "2023", name: "First Year Launch", theme: "The Beginning",
  ...
  {
    id: "moon", year: "2023", name: "Foundation Phase", theme: "Learning Foundations",
  ...
  {
    id: "iss", year: "2023", name: "Team Workflow", theme: "Collaboration",
  ...
  {
    id: "mars", year: "2024", name: "Product Builder", theme: "Building Real Products",
  ...
  {
    id: "jupiter", year: "2025", name: "Backend Scale", theme: "Engineering at Scale",
  ...
  {
    id: "saturn", year: "2026", name: "Hackathon Innovation", theme: "Innovation",
    ...
    projects: ["ShushrutAI", "DocLing AI (Runner-Up)", "FinAgent (Top 25)"],
  ...
  {
    id: "uranus", year: "2026", name: "Infrastructure Track", theme: "Infrastructure",
  ...
  {
    id: "neptune", year: "2027", name: "Graduation Orbit", theme: "Future Engineering",
  ...
  {
    id: "deep", year: "2027 →", name: "Next Chapter", theme: "The journey has only begun",
